...
;;; «.Hightlight-mark»                          (to "Hightlight-mark")
...
;;; «.emacs-shell-fm»                           (to "emacs-shell-fm")
...
(setq gnus-init-file "/home/thierry/.emacs.d/emacs-config-laptop/.gnus.el")
...
(add-to-list 'default-frame-alist '(font . "-unknown-DejaVu Sans Mono-bold-normal-normal-*-16-*-*-*-m-0-*-*"))
...
(global-set-key (kbd "\C-c j p") 'tv-jargon-at-point)
...
(global-set-key (kbd "<f7> i") (lambda () (interactive)
...
;; «ropemacs» (to ".ropemacs")
;; (setq pymacs-load-path '("/home/thierry/lib/python/rope"
;;                          "/home/thierry/lib/python/ropemacs"))
...
;; (add-to-list 'load-path "/home/thierry/elisp/extview")
;; (load "extview.elc")
(require 'extview)
...
(global-set-key (kbd "C-c C-s") 'anything-traverse-at-point)
...
;; (find-fline "~/labo/anything-config-qpatch/anything-config.el")
;; (find-fline "~/labo/anything-hg-qpatch/init-anything-thierry.el")
(require 'imenu)
