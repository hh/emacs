...
(defvar rcov-command-line "cd ~/soap/Luci && rake spec:rcov"
...
(defvar rcovsave-command-line "rcov --gcc --no-html --save=coverage.info ~/soap/Luci/runall.rb"
  "Rcov command line to save coverage status. See also `rcov-command-line'.")
(defvar rcovdiff-command-line "rcov -D --gcc --no-html ~/soap/soap_unittest.rb"
