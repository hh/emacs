...
(defvar color-themes
  '((color-theme-aalto-dark "Aalto Dark" "Jari Aalto <jari.aalto@poboxes.com>")
    ...
    (color-theme-ir_black "IR_Black" "ober@linbsd.org")
...
jde, senator, speedbar, and widget."
  ...
  (color-theme-install
   '(color-theme-aliceblue
     ...
     (jde-java-font-lock-underline-face ((t (:underline t))))
     (menu ((t (nil))))
     (modeline ((t (:backgrouncolor-themed "grey75" :foreground "black" :box (:line-width -1 :style released-button)))))
...
(defun color-theme-ir_black ()
  "Color theme by Ober, created 2009-06-01.
Green on black theme including font-lock, speedbar, and widget."
  ...
  (color-theme-install
   '(color-theme-ir_black
     ...
     (default ((t (:stipple nil :background "black" :foreground "#f6f3e8" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :width normal :family "misc-fixed"))))
     ;;(semantic-which-function-use-color . "black")
     (bold ((t (:bold t :weight bold))))
     (bold-italic ((t (:italic t :bold t :slant italic :weight bold))))
     (border ((t (:background "black"))))
     (comint-highlight-input ((t (:bold t :weight bold))))
     (comint-highlight-prompt ((t (:foreground "#96CBFE"))))
     (cursor ((t (:background "white"))))
     (fixed-pitch ((t (:family "courier"))))
     (font-lock-builtin-face ((t (:foreground "#f7f3e8"))))
     (font-lock-comment-face ((t (:foreground "#C7C7C7"))))
     (font-lock-constant-face ((t (:foreground "#f7f3e8"))))
     (font-lock-doc-face ((t (:foreground "#A8FF60"))))
     (font-lock-doc-string-face ((t (:foreground "A8FF60"))))
     (font-lock-function-name-face ((t (:foreground "#FFFFB6"))))
     (font-lock-keyword-face ((t (:foreground "#96CBFE"))))
     (font-lock-preprocessor-face ((t (:foreground "#A8FF60"))))
     (font-lock-reference-face ((t (nil))))
     (font-lock-string-face ((t (:foreground "#A8FF60"))))
     (font-lock-type-face ((t (:foreground "#FFD2A7"))))
     (font-lock-variable-name-face ((t (:foreground "#96CBFE"))))
     (font-lock-warning-face ((t (:bold t :foreground "#FF6C60" :weight bold))))
     (fringe ((t (:background "black" :foreground "#96CBFE"))))
     (header-line ((t (:box (:line-width -1 :style released-button) :background "black" :foreground "#FFD2A7" :box nil))))
     (highlight ((t (:background "#E18964"))))
     (horizontal-divider ((t (:background "black" :foreground "#96CBFE"))))
     (isearch ((t (:background "#c7c7c7" :foreground "#07281C"))))
     (isearch-lazy-highlight-face ((t (:background "#96CBFE"))))
     (italic ((t (:italic t :slant italic))))
     (menu ((t (:background "black" :foreground "#96CBFE"))))
     ;;(modeline ((t (:background "black" :foreground "#A8FF60" :box (:line-width -1 :style released-button)))))
     ;;(modeline ((t (:background "black" :foreground "#96CBFE" :box (:line-width -1 :style released-button)))))
     ;;(modeline-buffer-id ((t (:background "black" :foreground "#96CBFE"))))
     ;;(modeline-mousable ((t (:background "black" :foreground "#96CBFE"))))
     ;;(modeline-mousable-minor-mode ((t (:background "black" :foreground "#96CBFE"))))
     (mouse ((t (:background "#FFCCFF"))))
     ...
     ;(header-line ((t (:box (:line-width -1 :style released-button) :background "black" :foreground "dark slate blue" :box nil))))
     ...
     (primary-selection ((t (:background "#c7c7c7" :foreground "#96cbfe"))))
     (region ((t (:background "#1D1E2C"))))
     (scroll-bar ((t (:background "black" :foreground "#96CBFE"))))
     (secondary-selection ((t (:background "#96CBFE" :foreground "#FFD2A7"))))
     (show-paren-match-face ((t (:background "#FFCCFF"))))
     (show-paren-mismatch-face ((t (:background "#FFCCFF" :foreground "#FFB6B0"))))
     (speedbar-button-face ((t (:foreground "#96CBFE"))))
     (speedbar-directory-face ((t (:foreground "#96CBFE"))))
     (speedbar-file-face ((t (:foreground "#1D1E2C"))))
     (speedbar-highlight-face ((t (:background "#FFCCFF" :foreground "#96CBFE"))))
     (speedbar-selected-face ((t (:foreground "#96CBFE" :underline t))))
     (speedbar-tag-face ((t (:foreground "#96CBFE"))))
     ;; (modeline ((t (:foreground "light gray" :background "dark slate blue" :inverse-video nil :box (:line-width 2 :style released-button)))))
     ;; (mode-line-inactive ((t (:foreground "light gray" :background "gray30"
     ;;                          :inverse-video nil :box (:line-width 2 :style released-button)))))
     ;; (mode-line-highlight ((t (:foreground "black" :background "light sky blue"
     ...
     (tabbar-button-face ((t (:background "dark slate blue" :foreground "khaki" :box (:line-width 2 :color "black" :style released-button)))))
     (tabbar-default-face ((t (:background "dark slate blue" :foreground "light sky blue"))))
     (tabbar-selected-face ((t (:background "dark slate blue" :foreground "khaki" :box (:line-width 2 :style released-button)))))
     (tabbar-separator-face ((t (:foreground "khaki" :background "dark slate blue"))))
     (tabbar-unselected-face ((t (:background "dark slate blue" :foreground "light sky blue" :box (:line-width 2 :color "black" :style pressed-button)))))

     (tool-bar ((t (:background "#c7c7c7" :foreground "#96CBFE" :box (:line-width 1 :style released-button)))))
     ;;(tooltip ((t (:background "#c7c7c7" :foreground "#96CBFE"))))
     (tooltip ((t (:background "#c7c7c7" :foreground "black"))))
     (trailing-whitespace ((t (:background "#96CBFE"))))
     (underline ((t (:underline t))))
     (variable-pitch ((t (:family "helv"))))
     (vertical-divider ((t (:background "#c7c7c7" :foreground "#96CBFE"))))
     (widget-button-face ((t (:bold t :weight bold))))
     (widget-button-pressed-face ((t (:foreground "#96CBFE"))))
     (widget-documentation-face ((t (:foreground "#96CBFE"))))
     (widget-field-face ((t (:background "#C7C7C7"))))
     (widget-inactive-face ((t (:foreground "#96CBFE"))))
     (widget-single-line-field-face ((t (:background "#c7c7c7"))))
     (zmacs-region ((t (:background "#c7c7c7" :foreground "#96CBFE")))))))

(defun color-theme-euphoria ()
  "Color theme by oGLOWo, created 2000-04-19.
Green on #7c7c7c theme including font-lock, speedbar, and widget."
  (interactive)
  (color-theme-install
   '(color-theme-euphoria
     ...
     ((help-highlight-face . underline)
      (list-matching-lines-face . bold)
      (widget-mouse-face . highlight))
     (default ((t (:stipple nil :background "#7c7c7c" :foreground "#00ff00" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :width normal :family "misc-fixed"))))
     (bold ((t (:bold t :weight bold))))
     (bold-italic ((t (:italic t :bold t :slant italic :weight bold))))
     (border ((t (:background "#7c7c7c"))))
     (comint-highlight-input ((t (:bold t :weight bold))))
     (comint-highlight-prompt ((t (:foreground "cyan"))))
     (cursor ((t (:background "yellow"))))
     (fixed-pitch ((t (:family "courier"))))
     ...
     (primary-selection ((t (:background "#00ff00" :foreground "#7c7c7c"))))
     (region ((t (:background "#c7c7c7" :foreground "#FFD2A7"))))
     (scroll-bar ((t (:background "gray16" :foreground "#00ff00"))))
     (secondary-selection ((t (:background "#00ff00" :foreground "#7c7c7c"))))
     (show-paren-match-face ((t (:background "turquoise"))))
     (show-paren-mismatch-face ((t (:background "purple" :foreground "white"))))
